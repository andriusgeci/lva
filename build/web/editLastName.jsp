    ...
    <body>        
        ...
        <div id="wrapperContent">
            ...
            <section id="LoginRegisterBox">
                <h2 id="h2Form">Please Enter New Last Name</h2>
                <form name="registerCustomer" id="formValidation" method="post" action="UserActionServlet" class="minimal">
                    ...
                    <input type="hidden" name="action" value="updateLastName" />
                    <button type="submit" value="updateLastName" class="button button--inline-block button--medium btn" id="btn">Update</button>
                </form>
            </section>
        </div>
