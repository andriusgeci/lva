    ...
    <body>  
        ...
        <div id="wrapperContent">
            ...
            <section id="LoginRegisterBox">
                <h2 id="h2Form">Personal Information</h2>
                <hr>
                <b>First Name: </b><a href="editName.jsp"><%=c.getFirstName()%> <i id="headerIcons" class="material-icons">mode_edit</i>Edit</a><br><br>
                <b>Last Name: </b><a href="editLastName.jsp"> <%=c.getLastName()%> <i id="headerIcons" class="material-icons">mode_edit</i>Edit</a><br><br>
                <b>Email: </b><a href="editEmail.jsp"> <%=c.getEmail()%> <i id="headerIcons" class="material-icons">mode_edit</i>Edit</a><br><br>
                <b>Password: </b><a href="editPassword.jsp"> *************** <i id="headerIcons" class="material-icons">mode_edit</i>Edit</a><br><br>
                <hr>
            </section>
        </div>
        <div id="footer1">
