    ...
    <body>        
        ...
        <div id="wrapperContent">
            <section id="LoginRegisterBox">
                <h2 id="h2Form" style="text-align: center">Thank You</h2>
                ...
                <form id="formCheckEmail">
                    <button formaction="login.jsp" class="button button--inline-block button--medium"  >Login to Site</button>
                </form>
            </section>
