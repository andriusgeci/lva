        ...
        <div id="wrapperContent">
            ...
            <section id="LoginRegisterBox">
                ...
                <form name="loginCustomer" id="formValidation" method="post" action="UserActionServlet" class="minimal">
                    ...
                    <button type="submit" value="login" class="button button--inline-block button--medium btn" id="btn">Sign in</button>
                    <div id="regLoginLinks">
                        <a  id="registerForgotPassword" href="register.jsp">Register</a> | <a id="registerForgotPassword" href="forgotPassword.jsp">Forgot password?</a>
                    </div>
                </form>
            </section>
