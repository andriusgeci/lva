    ...
    <body>      
        ...
        <div id="wrapperContent">
            <section id="LoginRegisterBox">
                ...
                <h2 id="h2Form" style="text-align: center;">Forgotten your password?</h2>
                <h3>Please enter your email address</br>(the email address you used to register your account).</h3>
                <form name="forgotPass" id="formValidation" method="post" action="UserActionServlet" class="minimal">
                    <label for="Email">
                        <p id="pForm">Email</p>
                    ...
                    <button type="submit" value="forgotPass" class="button button--inline-block button--medium btn" id="btn">Send Verification Link</button>
                </form>
            </section>
