...
public class MoviePriceAscComparator implements Comparator<Movie> {

    /**
     * This method compares movies by price in ascending order
     *
    ...
    public int compare(Movie mv1, Movie mv2) {
        return ((int) mv1.getPrice() - (int) mv2.getPrice());
    }
}
