    ...
    <body>  
        ...
        <div id="wrapperContent">
            ...
            <section id="AddressBox">
                <hr>
                <b>Please Enter Address Details</b><br>
                <hr>
                <form name="addAddress" id="formValidation" method="post" action="UserActionServlet" class="minimal">
                    <label for="PrimaryAddress">
                        <% if (primary == true) {%>
                        <input checked="checked" name="tick" type="radio" value="false" /> <b>Secondary Address</b>
                        <%} else if(x == 0  && primary == false) {%>
                        <input checked="checked" name="tick" type="radio" value="true" /><b>Primary/Shipping</b>
                        <%}else{%>
                    ...
                    <label for="Address1">
                        ...
                        <input type="text" minlength="3" maxlength="100" name="address1" placeholder="Please enter Address line 1" required="required" title="Please enter Address line 1" />
                    </label>
                    <label for="Address2">
                        <p id="pForm">Address Line 2 </p>
                        <input type="text" minlength="3" maxlength="100"  name="address2" placeholder="Please enter Address line 2(Not Required)" />
                    </label>
                    <label for="City">
                        <p id="pForm">City</p>
                        <input type="text" minlength="3" maxlength="100" name="city" placeholder="Please enter you're City" required="required" title="Please enter you're City"/>
                    </label>
                    <label for="County">
                        <p id="pForm">County</p>
                        <input type="text" minlength="3" maxlength="100" name="county" placeholder="Please enter you're County (Not Required)"/>
                    </label>
                    <label for="PostalCode">
                        <p id="pForm">Postal Code</p>
                        <input type="text" minlength="3" maxlength="100" name="postalCode" placeholder="Please enter you're Postal Code (Not Required)"/>
                    </label>
                    <label for="Country">
                        <p id="pForm">Country</p>
                        <input type="text" minlength="3" maxlength="100" name="country" placeholder="Please enter you're Country" required="required" title="Please enter you're Country"/>
                    </label>
                    <br>
                    <hr>
